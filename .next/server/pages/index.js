...
async function getStaticProps() {
    const client = await external_mongodb_.MongoClient.connect("mongodb+srv://ostkuzbyt:55555678@cluster0.gmptkfx.mongodb.net/meetups?retryWrites=true&w=majority");
    const db = client.db();
